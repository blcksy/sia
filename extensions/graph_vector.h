...
bool mysort(pair<int,double> x, pair<int,double> y){ 
...
class Graph {
    ...
    private:
        ...
        vector< pair <int,double> >::iterator myfind(
                vector<pair<int, double> >::iterator first,
                vector<pair<int, double> >::iterator last, 
                int x
        ){
